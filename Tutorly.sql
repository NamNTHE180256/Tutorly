...
(14, 1, N'Vũ Thanh Hải', 1, 'tutor7.jpg', 
    ...
    N'Đại học Sư phạm Hà Nội', 280.0, 'Bank1', 'Active'),
(15, 2, N'Lê Thị Minh', 0, 'tutor8.jpg', 
    ...
    N'Đại học Sư phạm TP.HCM', 290.0, 'Bank2', 'Active'),
(16, 3, N'Phạm Văn Cường', 1, 'tutor9.jpg', 
    ...
    N'Đại học Quốc gia Hà Nội', 300.0, 'Bank3', 'Active'),
(17, 4, N'Trần Thu Hà', 0, 'tutor10.jpg', 
    ...
    N'Đại học Khoa học Tự nhiên', 260.0, 'Bank1', 'Active'),
(18, 5, N'Nguyễn Minh Tú', 1, 'tutor11.jpg', 
    ...
    N'Đại học Bách Khoa Đà Nẵng', 270.0, 'Bank2', 'Active'),
(19, 6, N'Hoàng Văn Anh', 1, 'tutor12.jpg', 
    ...
    N'Đại học Bách Khoa Hà Nội', 280.0, 'Bank3', 'Active'),
(20, 7, N'Phạm Ngọc Linh', 0, 'tutor13.jpg', 
    ...
    N'Đại học Khoa học Tự nhiên', 250.0, 'Bank1', 'Active'),
(21, 8, N'Nguyễn Hữu Đức', 1, 'tutor14.jpg', 
    ...
    N'Đại học Sư phạm Hà Nội', 260.0, 'Bank2', 'Active'),
(22, 9, N'Vũ Thị Hương', 0, 'tutor15.jpg', 
    ...
    N'Đại học Sư phạm TP.HCM', 270.0, 'Bank3', 'Active'),
(23, 10, N'Nguyễn Thị Lan', 0, 'tutor16.jpg', 
    ...
    N'Đại học Ngoại thương', 300.0, 'Bank1', 'Active'),
(24, 11, N'Trần Văn Hùng', 1, 'tutor17.jpg', 
    ...
    N'Đại học Khoa học Xã hội và Nhân văn', 310.0, 'Bank2', 'Active'),
(25, 12, N'Phạm Thị Thanh', 0, 'tutor18.jpg', 
    ...
    N'Đại học Hà Nội', 320.0, 'Bank3', 'Active'),
...
(29, 1, N'Lê Văn Quang', 1, 'tutor22.jpg', 
    ...
    N'Đại học Khoa học Tự nhiên', 290.0, 'Bank1', 'Active'),
(30, 2, N'Nguyễn Thị Hoa', 0, 'tutor23.jpg', 
    ...
    N'Đại học Sư phạm Hà Nội', 300.0, 'Bank2', 'Active'),
(31, 3, N'Phạm Văn Hùng', 1, 'tutor24.jpg', 
    N'Phạm Văn Hùng, giáo viên Toán học lớp 12 với 15 năm kinh nghiệm. Tôi luôn khơi gợi sự hứng thú và đam mê học tập ở mỗi học sinh.', 
    N'Đại học Khoa học Tự nhiên', 310.0, 'Bank3', 'Active'),
(32, 4, N'Nguyễn Thu Hà', 0, 'tutor25.jpg', 
    N'Nguyễn Thu Hà, giáo viên Vật lý lớp 10. Tôi luôn cố gắng giúp học sinh hiểu rõ bản chất và yêu thích môn học.', 
    N'Đại học Khoa học Tự nhiên', 260.0, 'Bank1', 'Active'),
(33, 5, N'Trần Văn An', 1, 'tutor26.jpg', 
    N'Trần Văn An, giáo viên Vật lý lớp 11. Tôi đã giúp nhiều học sinh đạt điểm cao trong các kỳ thi quốc gia.', 
    N'Đại học Bách Khoa Đà Nẵng', 270.0, 'Bank2', 'Active'),
(34, 6, N'Phạm Thị Hằng', 0, 'tutor27.jpg', 
    N'Phạm Thị Hằng, giáo viên Vật lý lớp 12. Tôi luôn cố gắng mang đến phương pháp học hiệu quả và tạo động lực học tập cho học sinh.', 
    N'Đại học Bách Khoa Hà Nội', 280.0, 'Bank3', 'Active'),
(35, 7, N'Nguyễn Văn Bình', 1, 'tutor28.jpg', 
    N'Nguyễn Văn Bình, giáo viên Hóa học lớp 10. Tôi luôn mang đến những bài học thú vị và sáng tạo.', 
    N'Đại học Sư phạm Hà Nội', 250.0, 'Bank1', 'Active'),
(36, 8, N'Nguyễn Thị Mai', 0, 'tutor29.jpg', 
    N'Nguyễn Thị Mai, giáo viên Hóa học lớp 11. Tôi luôn giúp học sinh hiểu rõ bản chất và yêu thích môn học.', 
    N'Đại học Khoa học Tự nhiên', 260.0, 'Bank2', 'Active'),
(37, 9, N'Vũ Thị Lan', 0, 'tutor30.jpg', 
    N'Vũ Thị Lan, giáo viên Hóa học lớp 12 với 8 năm kinh nghiệm. Tôi luôn nỗ lực mang đến phương pháp học tập hiệu quả nhất cho học sinh.', 
    N'Đại học Sư phạm TP.HCM', 270.0, 'Bank3', 'Active'),
(38, 10, N'Trần Văn Minh', 1, 'tutor31.jpg', 
    N'Trần Văn Minh, giáo viên Tiếng Anh lớp 10. Tôi giúp học sinh cải thiện kỹ năng giao tiếp và đạt điểm cao trong các kỳ thi.', 
    N'Đại học Ngoại thương', 300.0, 'Bank1', 'Active'),
(39, 11, N'Nguyễn Văn Hùng', 1, 'tutor32.jpg', 
    N'Nguyễn Văn Hùng, giáo viên Tiếng Anh lớp 11. Tôi đã giúp nhiều học sinh đạt chứng chỉ IELTS và TOEFL với điểm số cao.', 
    N'Đại học Khoa học Xã hội và Nhân văn', 310.0, 'Bank2', 'Active'),
(40, 12, N'Nguyễn Thị Phương', 0, 'tutor33.jpg', 
    N'Nguyễn Thị Phương, giáo viên Tiếng Anh lớp 12 với 12 năm kinh nghiệm. Tôi luôn cố gắng mang đến phương pháp học tập hiệu quả và sáng tạo.', 
    N'Đại học Hà Nội', 320.0, 'Bank3', 'Active'),
(41, 13, N'Lê Văn Tùng', 1, 'tutor34.jpg', 
    N'Lê Văn Tùng, giáo viên Văn học lớp 10 với 12 năm kinh nghiệm. Tôi luôn giúp học sinh yêu thích và đạt điểm cao trong môn Văn.', 
    N'Đại học Sư phạm Hà Nội', 280.0, 'Bank1', 'Active'),
(42, 14, N'Nguyễn Thị Hằng', 0, 'tutor35.jpg', 
    N'Nguyễn Thị Hằng, giáo viên Văn học lớp 11 với 8 năm kinh nghiệm. Tôi luôn nỗ lực mang đến những bài học thú vị và sáng tạo cho học sinh.', 
    N'Đại học Sư phạm TP.HCM', 290.0, 'Bank2', 'Active'),
(43, 15, N'Phạm Văn Hoàng', 1, 'tutor36.jpg', 
    N'Phạm Văn Hoàng, giáo viên Văn học lớp 12 với 15 năm kinh nghiệm. Tôi luôn cố gắng giúp học sinh nắm vững kiến thức và đạt điểm cao trong các kỳ thi.', 
    N'Đại học Quốc gia Hà Nội', 300.0, 'Bank3', 'Active'),
(44, 1, N'Nguyễn Văn Kiên', 1, 'tutor37.jpg', 
    N'Nguyễn Văn Kiên, giáo viên Toán học lớp 10. Tôi giúp học sinh nắm vững kiến thức và đạt điểm cao trong các kỳ thi.', 
    N'Đại học Khoa học Tự nhiên', 290.0, 'Bank1', 'Active'),
(45, 2, N'Phạm Thị Ngân', 0, 'tutor38.jpg', 
    N'Phạm Thị Ngân, giáo viên Toán học lớp 11. Tôi luôn cố gắng mang đến phương pháp học tập hiệu quả nhất cho học sinh.', 
    N'Đại học Sư phạm Hà Nội', 300.0, 'Bank2', 'Active'),
(46, 3, N'Nguyễn Văn Long', 1, 'tutor39.jpg', 
    N'Nguyễn Văn Long, giáo viên Toán học lớp 12 với 15 năm kinh nghiệm. Tôi luôn khơi gợi sự hứng thú và đam mê học tập ở mỗi học sinh.', 
    N'Đại học Khoa học Tự nhiên', 310.0, 'Bank3', 'Active'),
(47, 4, N'Lê Thị Huệ', 0, 'tutor40.jpg', 
    N'Lê Thị Huệ, giáo viên Vật lý lớp 10. Tôi luôn cố gắng giúp học sinh hiểu rõ bản chất và yêu thích môn học.', 
    N'Đại học Khoa học Tự nhiên', 260.0, 'Bank1', 'Active');


	SELECT * FROM Tutor WHERE subjectId =2 and id <> 7
...
(1, 31, 4, N'Cô dạy rất nhiệt tình', GETDATE()),
(2, 32, 5, N'Bài giảng chi tiết và dễ hiểu', GETDATE()),
(3, 33, 4, N'Thầy rất nhiệt tình và dễ hiểu', GETDATE()),
(4, 34, 3, N'Cần thêm bài tập thực hành', GETDATE()),
(5, 35, 5, N'Thầy giảng rất dễ hiểu và nhiệt tình', GETDATE()),
(6, 36, 4, N'Rất hài lòng với phương pháp giảng dạy', GETDATE()),
(1, 37, 5, N'Thầy rất tận tâm và nhiệt tình', GETDATE()),
(2, 38, 4, N'Rất hài lòng', GETDATE()),
(3, 39, 5, N'Thầy dạy rất dễ hiểu và tận tâm', GETDATE()),
(4, 40, 3, N'Bài giảng cần chậm hơn', GETDATE()),
(5, 7, 4, N'Cô dạy rất nhiệt tình', GETDATE()),
(6, 8, 5, N'Bài giảng chi tiết và dễ hiểu', GETDATE()),
(1, 9, 4, N'Thầy rất nhiệt tình và dễ hiểu', GETDATE()),
(2, 10, 3, N'Cần thêm bài tập thực hành', GETDATE()),
(3, 11, 5, N'Thầy giảng rất dễ hiểu và nhiệt tình', GETDATE()),
(4, 12, 4, N'Rất hài lòng với phương pháp giảng dạy', GETDATE()),
(5, 13, 5, N'Thầy rất tận tâm và nhiệt tình', GETDATE()),
(6, 14, 4, N'Rất hài lòng', GETDATE()),
(1, 15, 5, N'Thầy dạy rất dễ hiểu và tận tâm', GETDATE()),
(2, 16, 3, N'Bài giảng cần chậm hơn', GETDATE()),
(3, 17, 4, N'Cô dạy rất nhiệt tình', GETDATE()),
(4, 18, 5, N'Bài giảng chi tiết và dễ hiểu', GETDATE()),
(5, 19, 4, N'Thầy rất nhiệt tình và dễ hiểu', GETDATE()),
(6, 20, 3, N'Cần thêm bài tập thực hành', GETDATE()),
(1, 21, 5, N'Thầy giảng rất dễ hiểu và nhiệt tình', GETDATE()),
(2, 22, 4, N'Rất hài lòng với phương pháp giảng dạy', GETDATE()),
(3, 23, 5, N'Thầy rất tận tâm và nhiệt tình', GETDATE()),
(4, 24, 4, N'Rất hài lòng', GETDATE()),
(5, 25, 5, N'Thầy dạy rất dễ hiểu và tận tâm', GETDATE()),
(6, 26, 3, N'Bài giảng cần chậm hơn', GETDATE()),
(1, 27, 4, N'Cô dạy rất nhiệt tình', GETDATE()),
(2, 28, 5, N'Bài giảng chi tiết và dễ hiểu', GETDATE()),
(3, 29, 4, N'Thầy rất nhiệt tình và dễ hiểu', GETDATE()),
(4, 30, 3, N'Cần thêm bài tập thực hành', GETDATE()),
(5, 31, 5, N'Thầy giảng rất dễ hiểu và nhiệt tình', GETDATE()),
(6, 32, 4, N'Rất hài lòng với phương pháp giảng dạy', GETDATE()),
(1, 33, 5, N'Thầy rất tận tâm và nhiệt tình', GETDATE()),
(2, 34, 4, N'Rất hài lòng', GETDATE()),
(3, 35, 5, N'Thầy dạy rất dễ hiểu và tận tâm', GETDATE()),
(4, 36, 3, N'Bài giảng cần chậm hơn', GETDATE());
...
(N'Material1.pdf', 'path/to/material1.pdf', 'PDF', GETDATE(), 1),
(N'Material2.pptx', 'path/to/material2.pptx', 'PPTX', GETDATE(), 2),
(N'Document1.docx', 'path/to/document1.docx', 'Document', GETDATE(), 3),
(N'Presentation1.pptx', 'path/to/presentation1.pptx', 'Powerpoint', GETDATE(), 4),
(N'Video1.mp4', 'path/to/video1.mp4', 'Video', GETDATE(), 5),
(N'Link1', 'http://example.com/link1', 'Link', GETDATE(), 6),
(N'Book1.pdf', 'path/to/book1.pdf', 'Book', GETDATE(), 7),
(N'Document2.docx', 'path/to/document2.docx', 'Document', GETDATE(), 8),
(N'Presentation2.pptx', 'path/to/presentation2.pptx', 'Powerpoint', GETDATE(), 9),
(N'Video2.mp4', 'path/to/video2.mp4', 'Video', GETDATE(), 10),
(N'Link2', 'http://example.com/link2', 'Link', GETDATE(), 11),
(N'Book2.pdf', 'path/to/book2.pdf', 'Book', GETDATE(), 12);
