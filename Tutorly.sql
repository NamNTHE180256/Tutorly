...
('learner5@gmail.com', '1', 'learner', GETDATE()), --5
...
('tutor4@example.com', '2', 'tutor', GETDATE()), --10
('tutor5@example.com', '2', 'tutor', GETDATE()),
('tutor6@example.com', '2', 'tutor', GETDATE()),
('manager1@example.com', '3', 'manager', GETDATE()),
('manager2@example.com', '3', 'manager', GETDATE()),
('manager3@example.com', '3', 'manager', GETDATE()), --15
('manager4@example.com', '3', 'manager', GETDATE()),
('manager5@example.com', '3', 'manager', GETDATE()),
('manager6@example.com', '3', 'manager', GETDATE()),
('manager7@example.com', '3', 'manager', GETDATE()),
('manager8@example.com', '3', 'manager', GETDATE()), --20
('admin1@example.com', '4', 'admin', GETDATE());
...
(35, 7, N'Nguyễn Văn Bình', 1, 'tutor28.jpg', 
    ...
    N'Đại học Sư phạm Hà Nội', 250.0, 'Bank1', 'Pending'),
(36, 8, N'Nguyễn Thị Mai', 0, 'tutor29.jpg', 
    ...
    N'Đại học Khoa học Tự nhiên', 260.0, 'Bank2', 'Pending'),
...
(46, 3, N'Nguyễn Văn Long', 1, 'tutor39.jpg', 
    ...
    N'Đại học Khoa học Tự nhiên', 310.0, 'Bank3', 'Pending'),
