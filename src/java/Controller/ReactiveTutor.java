 ...
 * @author Admin
 */
@WebServlet(name="ReactiveTutor", urlPatterns={"/ReactiveTutor"})
public class ReactiveTutor extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ReactiveTutor</title>");  
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet ReactiveTutor at " + request.getContextPath () + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    } 
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            email.setSubject("[Tutorly] Your Tutor Account has been Reactivated.");
            ...
            String emailContent = "<html>"
                    ...
                    + "<div class='content'>"
                    + "<p>We are pleased to inform you that your account on <strong>Tutorly</strong> has been <i>REACTIVATED</i>.</p>"
