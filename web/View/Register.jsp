<%-- 
    Document   : Register
    Created on : Jun 6, 2024, 2:10:48 PM
    Author     : Acer
--%>
                ...
                <div class="col-md-6 d-flex justify-content-center align-items-center bg-white text-dark position-relative left-half">
                    ...
                    <div class="login-container mt-5">
                        ...
                        <form class="register-form" action="${pageContext.request.contextPath}/Register" method="post">
                            ...
                            <button style="margin: 0 35%;" type="submit" class="btn btn-primary btn-sm register-button">Register</button>
                        </form>
                        <div><p style="color: red">${requestScope.messageError}</p></div>
                        <div>
                            Already have an account? <a href="../View/Login.jsp" class="" style="margin-left: 10px; color:black">Login</a>
                        </div>
                    </div>
                </div>
