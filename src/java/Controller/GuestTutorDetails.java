 ...
 * @author TRANG
 */
@WebServlet(name="GuestTutorDetails", urlPatterns={"/GuestTutorDetails"})
public class GuestTutorDetails extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        RequestDispatcher dispatcher = request.getRequestDispatcher("View/GuestTutorDetails.jsp");
