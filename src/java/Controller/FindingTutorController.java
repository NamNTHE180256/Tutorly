 ...
 * @author TRANG
 */
@WebServlet(name="FindingTutorController", urlPatterns={"/FindingTutorController"})
public class FindingTutorController extends HttpServlet {
    ...
    // Forward to JSP
    RequestDispatcher dispatcher = request.getRequestDispatcher("View/FindingTutor.jsp");
